...
$sql = "select service.id,class.title className,service.service_order,service.keywords,date_format(service.addTime,'%Y-%m-%d') addTime from service left join class on class.id=service.classID where class.firstID=2 order by service.classID, service.service_order desc,service.addTime desc";
...
$smarty->assign("page",page("managerservice.php",$currentPage,$totalPage));

$smarty->display("Admin/managerservice.tpl");
