...
<table width="95%" border="1" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td height="30"  style="background-image:url(images/bg_list.gif)"><div style="margin-left:10px; font-weight:bold; color:#ffffff; font-size:16px">留言管理</div></td>
  </tr>
  <tr>
      ...
      <tr>
	   ...
	   <tr><td colspan="6"><hr width="100%" size="1" color="#CCCCCC"></td></tr>
		  ...
		  <td align="left"><input name="selectid[]" type="checkbox" id="selectid" value="<{$item.id}>"></td>
			...
			<td><a href="ShowMessage.php?id=<{$item.id}>"><{$item.userName}></a></td>
			<td><{$item.mobile}></td>
			<td><{$item.email}></td>
			<td><{$item.addTime}></td>
			<td><a href="Message.php?action=deleteMessage&id=<{$item.id}>">删除</a></td>
		 </tr>
		 <{/foreach}>
		 <tr><td colspan="6"><hr width="100%" size="1" color="#CCCCCC"></td></tr>
