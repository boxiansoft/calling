...
<table width="95%" border="1" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td height="30"  style="background-image:url(images/bg_list.gif)"><div style="margin-left:10px; font-weight:bold; color:#ffffff; font-size:16px">客户管理中心</div></td>
  </tr>
  <tr>
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="2%"></td><td width="8%">客户排序</td><td width="20%">客户图片</td><td width="30%">客户名称</td><td width="10%">客户网址</td><td width="15%">添加时间</td><td width="15%">操作</td>
      </tr>
	   <tr><td colspan="7"><hr width="100%" size="1" color="#CCCCCC"></td></tr>
	   	  <{foreach key = key item = item from = $newsList}>
		  ...
		  <td align="left"><input name="selectid[]" type="checkbox" id="selectid" value="<{$item.id}>"></td>
			...
			<td><img src="../upload/<{$item.pic}>" width="100" height="50" border="0" /></td>
			<td><{$item.customer_name}></td>
			<td><{$item.url}></td>
			<td><{$item.addTime}></td>
			<td><a href="addcustomer.php?ID=<{$item.id}>">修改</a>&nbsp;|&nbsp;<a href="updatecustomer.php?action=deletecustomer&ID=<{$item.id}>">删除</a></td>
		 </tr>
		 <{/foreach}>
		 <tr><td colspan="7"><hr width="100%" size="1" color="#CCCCCC"></td></tr>
