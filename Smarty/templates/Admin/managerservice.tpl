...
<table width="95%" border="1" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td height="30"  style="background-image:url(images/bg_list.gif)"><div style="margin-left:10px; font-weight:bold; color:#ffffff; font-size:16px">服务管理中心</td>
  </tr>
  <tr>
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="2%"></td><td width="20%">服务类别</td><td width="10%">服务排序</td><td width="20%">服务关键字</td><td width="15%">添加时间</td><td width="15%">操作</td>
      </tr>
	   <tr><td colspan="6"><hr width="100%" size="1" color="#CCCCCC"></td></tr>
		  ...
		  <td align="left"><!--<input name="selectid[]" type="checkbox" id="selectid" value="<{$item.id}>">--></td>
			...
			<td><{$item.keywords}></td>
			<td><{$item.addTime}></td>
			<td><a href="addservice.php?ID=<{$item.id}>">修改</a><!--&nbsp;|&nbsp;<a href="updateservice.php?action=deleteservice&ID=<{$item.id}>">删除</a>--></td>
		 </tr>
		 <{/foreach}>
		 <tr><td colspan="6"><hr width="100%" size="1" color="#CCCCCC"></td></tr>
