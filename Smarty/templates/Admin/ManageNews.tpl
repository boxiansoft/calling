      ...
      <tr>
	   ...
	   <tr><td colspan="5"><hr width="100%" size="1" color="#CCCCCC"></td></tr>
		  ...
		  <td align="left"><input name="selectid[]" type="checkbox" id="selectid" value="<{$item.id}>"></td>
			...
			<td height="30"><a href="../shownews.php?id=<{$item.id}>" target="_blank"><{$item.title}></a></td>
			<td><{$item.className}></td>
			<td><{$item.addTime}></td>
			<td><a href="AddNews.php?classID=<{$item.classID}>&id=<{$item.id}>">修改</a>&nbsp;|&nbsp;<a href="UpdateNews.php?action=deleteNews&id=<{$item.id}>">删除</a></td>
		 </tr>
		 <{/foreach}>
		 <tr><td colspan="5"><hr width="100%" size="1" color="#CCCCCC"></td></tr>
