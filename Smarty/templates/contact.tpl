...
<div class="index_main_body">	
	<div class="main1002 f_n">
		<div class="daohang">
			<img src="images/icon.png" width="5" height="5" border="0"/>&nbsp;&nbsp;<a href="index.php">首页</a>&nbsp;>&nbsp;优尔通服务&nbsp;>&nbsp;<{$currentTitle}>
		</div>
		
		<{include file="common/contact_left.tpl" name="about_left"}>
		...
		<div class="about_right_list">
			...
			<div class="about_right_memo">
				...
				<div class="about_right_memo_detail">
					<div class="service_right_memo_content"><span><{$aboutDetail}></span></div>
					<!--<{if $smarty.get.id==35}>
					<div class="contact_map"><img src="images/contact_map.png" width="656" height="325" border="0"/></div>
					<{/if}>-->
				</div>
			</div>
		</div>
