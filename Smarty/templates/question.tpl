...
<div class="index_main_body">	
	<div class="main1002 f_n">
		<div class="daohang">
			<img src="images/icon.png" width="5" height="5" border="0"/>&nbsp;&nbsp;<a href="index.php">首页</a>&nbsp;>&nbsp;常见问题
		</div>
		
		<{include file="common/question_left.tpl" name="question_left"}>
		
		<div class="about_right_list">
			<div class="about_right_title"><img src="images/about_top_menu_left.png" width="3" height="13" border="0"/><span class="about_right_title_cn">常见问题</span><span class="about_right_title_en"><{$currentEnTitle}></span></div>
			...
			<div class="about_right_memo">
				<div class="about_right_memo_pic"><span>常见问题</span></div>
				<div class="about_right_memo_detail">
					<div class="about_news_list">
						<{foreach item=item key=key from=$aboutNewsList}>
						<ul>
							<li class="w_45">■</li>
							<li class="w_515"><a href="showquestion.php?id=<{$smarty.get.id}>&smallID=<{$item.id}>" target="_blank"><{$item.title}></a></li>
