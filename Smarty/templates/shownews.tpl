...
<div class="index_main_body">	
	<div class="main1002 f_n">
		<div class="daohang">
			<img src="images/icon.png" width="5" height="5" border="0"/>&nbsp;&nbsp;<a href="index.php">首页</a>&nbsp;>&nbsp;<a href="about.php?id=46">优尔通快讯</a>&nbsp;>&nbsp;<{$showNewsTitle}>
		</div>
		
		<{include file="common/show_news_left.tpl" name="show_news_left"}>
		
		<div class="about_right_list">
			<div class="about_right_title"><img src="images/about_top_menu_left.png" width="3" height="13" border="0"/><span class="about_right_title_cn">优尔通快讯</span><span class="about_right_title_en">News</span></div>
			<div class="about_right_title_bottom"><img src="images/about_top_title_bottom.png" width="753" height="2" border="0"/></div>
			<div class="about_right_top_pic"><img src="images/about_top_004.png" width="754" height="141" border="0"/></div>
