...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck','TextColor','BGColor','FitWindow','-','About','Image'],
...
FCKConfig.ToolbarSets["Company"] = [	
	['Copy','PasteText','-','Image','Link','Unlink','Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['TextColor','BGColor','FontName','FontSize']
] ;

FCKConfig.ToolbarSets["Basic"] = [
	['Source','PasteText','Bold','Italic','-','Link','Unlink','Image','-','TextColor','BGColor','FontName','FontSize']
] ;
...
FCKConfig.FontNames		= '宋体;黑体;隶书;楷体_utf8;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
