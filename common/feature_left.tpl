<div class="about_left_list">
	<div class="aboutLeft">
		<ul>
			...
			<li class="currentAboutMenu"><a href="feature.php?id=<{$serviceList[about].id}>"><{$serviceList[about].title}></a></li>
			<{else}>
			<li class="aboutMenu"><a href="feature.php?id=<{$serviceList[about].id}>"><{$serviceList[about].title}></a></li>
			<{/if}>
			<{/section}>
		</ul>			
	</div>
